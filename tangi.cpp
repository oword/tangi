...
int main(int, char**)
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Tangi - music player (in the works)", WS_OVERLAPPEDWINDOW, 100, 100, (int)(1280 * main_scale), (int)(800 * main_scale), nullptr, nullptr, wc.hInstance, nullptr);
    ...
    bool show_tangi_window = true;
    bool show_imgui_default_window = false;
    ...
    while (!done)
    {
        ...
        if (show_tangi_window)
        {
            ImGuiViewport* viewport{ImGui::GetMainViewport()};

            //fitting the tangi window to the size of the viewport
